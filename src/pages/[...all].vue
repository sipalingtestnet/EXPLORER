...
<template>
    <div class="pt-10">
        ...
        <div class="misc-avatar w-full text-center">
            <RouterLink to="/" class="btn no-underline bg-[#f7921e] text-black hover:bg-[#ffffff] dark:hover:bg-[#202020] dark:hover:text-white hover:shadow-[0_0_10px_3px_rgba(255,234,110,1)] mt-4">
                {{ $t('pages.btn_index') }}
            </RouterLink>
