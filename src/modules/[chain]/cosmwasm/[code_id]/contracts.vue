      ...
      <div class="overflow-x-auto">
            ...
            >
              ...
              <td>
                <label
                  ...
                  class="btn bg-[#f7921e] text-black hover:bg-[#ffffff] dark:hover:bg-[#202020] dark:hover:text-white hover:shadow-[0_0_10px_3px_rgba(255,234,110,1)] btn-xs text-xs mr-2"
                  >{{ $t('cosmwasm.btn_contract') }}</label
                >
                <RouterLink
                  :to="`transactions?contract=${v}`"
                  class="btn bg-[#f7921e] text-black hover:bg-[#ffffff] dark:hover:bg-[#202020] dark:hover:text-white hover:shadow-[0_0_10px_3px_rgba(255,234,110,1)] btn-xs text-xs"
                >
        ...
        <div class="flex justify-between">
          ...
          <label
            ...
            class="btn bg-[#f7921e] text-black hover:bg-[#ffffff] dark:hover:bg-[#202020] dark:hover:text-white hover:shadow-[0_0_10px_3px_rgba(255,234,110,1)] my-5"
            @click="
