    ...
    <div class="bg-[#222222] px-4 pt-3 pb-4 rounded mb-4 shadow">
      <div class="flex items-center">
        ...
        <div class="inline-flex relative w-11 h-11 rounded-md">
          <div
            class="w-11 h-11 absolute rounded-md opacity-10 bg-[#f7921e]"
          ></div>
          <div
    ...
    <div class="bg-[#222222] px-4 pt-3 pb-4 rounded mb-4 shadow">
      <div class="flex justify-between">
        ...
        <div class="flex justify-end mb-4 pr-5">
            <label
              for="send"
              class="btn bg-[#f7921e] text-black hover:bg-[#ffffff] dark:hover:bg-[#202020] dark:hover:text-white hover:shadow-[0_0_10px_3px_rgba(255,234,110,1)] btn-sm mr-2"
              @click="dialog.open('send', {}, updateEvent)"
              >{{ $t('account.btn_send') }}</label
            >
            <label
              for="transfer"
              class="btn bg-[#f7921e] text-black hover:bg-[#ffffff] dark:hover:bg-[#202020] dark:hover:text-white hover:shadow-[0_0_10px_3px_rgba(255,234,110,1)] btn-sm"
              @click="
                dialog.open(
                  'transfer',
                  {
        ...
        <div class="mt-4 md:!col-span-2 md:!mt-0 md:!ml-4">          
          ...
          <div class="">
            ...
            >
              ...
              >
                <span
                  class="inset-x-0 inset-y-0 opacity-10 absolute bg-[#f7921e] dark:invert text-sm"
                ></span>
            ...
            <div class="flex items-center px-4">
              ...
              <div
                class="text-xs truncate relative py-1 px-3 rounded-full w-fit text-primary dark:invert mr-2"
              >
                <span class="inset-x-0 inset-y-0 opacity-10 absolute bg-[#f7921e] dark:invert"></span>
                ${{format.tokenValue({
                      amount: String(unbondingTotal),
                      denom: stakingStore.params.bond_denom,
                    })
            ...
            <tr v-for="(v, index) in delegations" :key="index">
              ...
              <td class="py-3">
                <div v-if="v.balance" class="flex justify-end">
                  <label
                    for="delegate"
                    class="btn bg-[#f7921e] text-black hover:bg-[#ffffff] dark:hover:bg-[#202020] dark:hover:text-white hover:shadow-[0_0_10px_3px_rgba(255,234,110,1)] btn-xs mr-2"
                    @click="
                      dialog.open(
                        'delegate',
                        {
                  ...
                  <label
                    for="unbond"
                    class="btn bg-[#f7921e] text-black hover:bg-[#ffffff] dark:hover:bg-[#202020] dark:hover:text-white hover:shadow-[0_0_10px_3px_rgba(255,234,110,1)] btn-xs"
                    @click="
                      dialog.open(
                        'unbond',
                        {
