    ...
    <div class="gap-4 mb-4 grid lg:!!grid-cols-3 auto-rows-max">
      ...
      <div class="bg-[#ffffff] dark:bg-[#222222] px-4 pt-3 pb-4 rounded shadow">
        ...
        <div class="mt-6 grid grid-cols-2">
          <label
            for="vote"
            class="inline-flex items-center justify-center flex-wrap cursor-pointer select-none text-center transition duration-200 rounded-lg btn-sm bg-[#f7921e] text-black hover:bg-[#ffffff] dark:hover:bg-[#202020] dark:hover:text-white hover:shadow-[0_0_10px_3px_rgba(255,234,110,1)] float-right btn-sm mx-1"
      ...
      <div class="bg-[#ffffff] dark:bg-[#222222] px-4 pt-3 pb-5 rounded shadow lg:!!col-span-2">
        ...
        <div class="px-1">
          ...
          <div class="flex items-center mb-4">
            <div class="w-2 h-2 rounded-full bg-[#f7921e] mr-3"></div>
            <div class="text-base flex-1 text-main">
              {{ $t('gov.deposited_at') }}:
              {{
                format.toDay(
