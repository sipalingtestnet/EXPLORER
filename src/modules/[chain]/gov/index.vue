...
<template>
    <div>
        <div class="tabs tabs-boxed bg-transparent mb-4 text-center">
            <a class="tab text-gray-600 uppercase" :class="{ 'bg-[#f7921e]': tab === '2' }" @click="changeTab('2')">{{ $t('gov.voting') }}</a>
            <a class="tab text-gray-600 uppercase" :class="{ 'bg-[#f7921e]': tab === '3' }" @click="changeTab('3')">{{ $t('gov.passed') }}</a>
            <a class="tab text-gray-600 uppercase" :class="{ 'bg-[#f7921e]': tab === '4' }"
